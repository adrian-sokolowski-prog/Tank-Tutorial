...
namespace MathUtility
{
	...
	bool lineIntersectsPlayer(sf::Vector2f ahead, sf::Vector2f halfAhead, sf::Sprite player)
	{
		return distance(player.getPosition(), ahead) <= 200 ||
			distance(player.getPosition(), halfAhead) <= 200;
	}
	////////////////////////////////////////////////////////////
